...
from routefinder.envs import MTDVRPEnv
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint", type=str,
        default="/common/home/users/s/scgui/Code/2025-LLMCO/0424-routefinder-LO-CaDA-ReLD-dotNoise/logs/0424-routefinder-LO-CaDA-ReLD-dotNoise-P75-50-main/2025-04-24_21-08-31/checkpoints/epoch_295.ckpt",
        help="Path to the model checkpoint"
    )
    # 100
    # parser.add_argument(
    #     "--checkpoint", type=str,
    #     default="/common/home/users/s/scgui/Code/2025-LLMCO/0317-routefinder-LO-CaDA-contextSplit-ReLD-dist-NodeDec/logs/0401-routefinder-LO-CaDA-contextSplit-ReLD-Logdist-NodeDec-P20-newO-100-main/2025-04-04_22-34-45/checkpoints/epoch_295.ckpt",
    #     help="Path to the model checkpoint"
    # )
    parser.add_argument(
        "--problem",
    ...
    if opts.datasets is not None:
        ...
        data_paths = []
        for root, _, files in os.walk("../0210-routefinder/data"):
            for file in files:
                # print(file)
                if "test" not in root:
                    continue
                if file.endswith(".npz"):
                    ...
                    if str(opts.size) in file and "m" in root:
    ...
    if opts.save_results:
        ...
        savedir = f"results_m_l40s/main_ts15/{opts.size}/"
