...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--checkpoint", type=str,
    #     default="./logs/0424-routefinder-LO-StepDec-dotNoise-P75-50-main/2025-04-24_21-21-45/checkpoints/epoch_299.ckpt",
    #     help="Path to the model checkpoint"
    # )
    # 100
    parser.add_argument(
        "--checkpoint", type=str,
        default="./logs/0424-routefinder-LO-StepDec-dotNoise-tr25-100-main/2025-05-08_22-43-17/checkpoints/epoch_298.ckpt",
        help="Path to the model checkpoint"
    )
    parser.add_argument(
        "--problem",
    ...
    print(f"Enc Parameters: {total_params / 1e6:.4f} M")
    total_params = sum(p.numel() for p in model.policy.decoder.parameters())
    print(f"Dec Parameters: {total_params / 1e6:.4f} M")
